...
interface TotalWalletsCardProps {
  total: number;
  activeCount: number;
}

export function TotalWalletsCard({ total, activeCount }: TotalWalletsCardProps) {
  return (
    <Link href="/wallets" className="block transition-opacity hover:opacity-95">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs opacity-80">
                  {activeCount} active · governed spend
                </p>
              </div>
            </div>
